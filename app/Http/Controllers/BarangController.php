...
class BarangController extends Controller
{
    public function insert(){
        $barang = Barang::all();
        return view('insert', ['barangs' => $barang]);
    }
    public function viewuser(){
        $barang = Barang::get();
        return view('viewuser', ['barangs' => $barang]);
    }
    public function view(){
        $barang = Barang::get();
        return view('view', ['barangs' => $barang]);
    }
    public function insertBarang(Request $request){
        $request->validate([
            'kategoriBarang' => 'required|string', 'namaBarang' => 'required|string|min:5|max:80',
            'hargaBarang' => 'required|numeric', 'jumlahBarang' => 'required|numeric',
            'fotoBarang' => 'required',
        ]);
        ...
        Barang::create([
            'kategoriBarang' => $request->kategoriBarang,  'namaBarang' => $request->namaBarang,
            'hargaBarang' => $request->hargaBarang,  'jumlahBarang' => $request->jumlahBarang,
            'fotoBarang' => $fileName,
        ]);
    ...
    public function cetakfaktur(Request $request, $id){
        ...
        Faktur::create([
            'noInvoice' => $invoice, 'idUser' => $user,
            'idBarang' => $id, 'kategoriBarang' => $request->kategoriBarang,
            'namaBarang' => $request->namaBarang,  'totalHarga' => $total_harga,
            'jumlahBarang' => $request->jumlahBarang, 'alamat' => $request->alamat,
